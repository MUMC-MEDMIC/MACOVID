...
def main(command_line = None):
    ...
    mapreads.add_argument("--scheme", required = False, dest = "schemeDir", default = "primer_schemes/EMC/V5", type = str, help = "path to scheme directory (default: primer_schemes/EMC/V5)")
    ...
    rerun.add_argument("--scheme", required = False, dest = "schemeDir", default = "primer_schemes/EMC/V5", type = str, help = "path to scheme directory (default: primer_schemes/EMC/V5)")
